    ...
    <footer className="bg-[#18120C] text-[#FAF6EE]/80 pt-24 pb-12 border-t border-[#FAF6EE]/10 relative overflow-hidden">
      ...
      >
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-mono text-[#FAF6EE]/50">
          <p suppressHydrationWarning>© {new Date().getFullYear()} La Miette Bakes — Luxury Dessert Boutique. All Rights Reserved.</p>
              ...
              {activeModal === "privacy" && (
                <>
                  ...
                  <p className="text-sm text-[#FAF6EE]/80 font-sans leading-relaxed">
                    At La Miette Bakes, your privacy is paramount. All order information and delivery details are stored securely. We never share your personal data with third parties.
                  </p>
                </>
              )}
