...
export function Navbar({ cartCount = 0, onOpenCart }: NavbarProps) {
  ...
  const handleScrollToTop = (e: React.MouseEvent) => {
    ...
    if (typeof window !== "undefined") {
      ...
      if (win.__lenis) {
        win.__lenis.scrollTo(0, { duration: 1.4, force: true });
      }
      ...
      <header className="fixed top-0 left-0 right-0 z-[9000] px-3 sm:px-6 pt-3 sm:pt-4 pointer-events-none transition-all duration-300 select-none">
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-2.5 sm:gap-3 group shrink-0 whitespace-nowrap cursor-pointer text-left bg-transparent border-0 p-0"
